...
SE14R_FILES = {
    ...
    'word_cnts_file': join(SE14_DIR, 'restaurants/word_cnts.txt'),
    'aspect_rule_patterns_file': join(DATA_DIR, 'rule_patterns/se14r_aspect_mined_rule_patterns.txt'),
    'aspect_term_filter_file': join(SE14_DIR, 'restaurants/se14r_aspect_term_filter_vocab.txt'),
    'aspect_term_hit_rate_file': join(SE14_DIR, 'restaurants/se14r_aspect_term_hit_rate_file.txt'),
    # 'train_dep_tags_file': 'd:/data/tmp/restaurants-train-rule-dep.txt',
    # 'train_pos_tags_file': 'd:/data/tmp/restaurants-train-rule-pos.txt',
    # 'word_cnts_file': 'd:/data/tmp/word_cnts.txt',
    # 'aspect_rule_patterns_file': 'd:/data/tmp/se14r_aspect_mined_rule_patterns.txt',
    # 'aspect_term_filter_file': 'd:/data/tmp/se14r_aspect_term_filter_vocab.txt',
    # 'aspect_term_hit_rate_file': 'd:/data/tmp/se14r_aspect_term_hit_rate_file.txt'
}
